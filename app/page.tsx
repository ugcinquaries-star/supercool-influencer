  ...
  return (
    <div style={{ background: '#0D0A0E', minHeight: '100vh', color: 'white', fontFamily: 'sans-serif' }}>
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px 48px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
        <div style={{ fontWeight: 800, fontSize: '18px' }}>super<span style={{ color: '#D4AF87' }}>cool</span> influencer</div>
      ...
      <section style={{ textAlign: 'center', padding: '100px 48px 80px' }}>
        <div style={{ display: 'inline-block', background: 'rgba(158,24,43,0.12)', border: '1px solid rgba(158,24,43,0.35)', color: '#D4AF87', fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', padding: '6px 16px', borderRadius: '100px', marginBottom: '32px' }}>
        ...
        <h1 style={{ fontSize: '72px', fontWeight: 800, lineHeight: 1, letterSpacing: '-3px', marginBottom: '24px' }}>
          AI UGC Production Briefs.<br /><span style={{ color: '#D4AF87' }}>Velora Standard.</span>
        </h1>
        ...
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginBottom: '64px' }}>
          <Link href="/generate" style={{ background: 'linear-gradient(135deg, #9E182B, #D4AF87)', color: 'white', padding: '16px 36px', borderRadius: '100px', fontSize: '17px', fontWeight: 700, textDecoration: 'none' }}>⚡ Generate Free →</Link>
        ...
        <div style={{ display: 'flex', gap: '48px', justifyContent: 'center', flexWrap: 'wrap' }}>
          {[
            ...
            <div key={s.label} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '22px', fontWeight: 800, color: '#D4AF87' }}>{s.num}</div>
      ...
      <section style={{ padding: '80px 48px', maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{ fontSize: '12px', letterSpacing: '0.12em', textTransform: 'uppercase', color: '#D4AF87', fontWeight: 600, marginBottom: '16px' }}>Special Mode</div>
      ...
      <div style={{ margin: '0 48px 80px', background: 'rgba(124,58,237,0.12)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '24px', padding: '80px 48px', textAlign: 'center' }}>
        ...
        <Link href="/generate" style={{ display: 'inline-block', background: 'linear-gradient(135deg, #9E182B, #D4AF87)', color: 'white', padding: '18px 48px', borderRadius: '100px', fontSize: '18px', fontWeight: 700, textDecoration: 'none' }}>⚡ Generate Free Now →</Link>
      </div>
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.07)', padding: '32px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'rgba(255,255,255,0.4)', fontSize: '13px' }}>
        <div style={{ fontWeight: 800 }}>super<span style={{ color: '#D4AF87' }}>cool</span> influencer</div>
